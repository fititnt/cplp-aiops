...
#
# Login:
#   ssh user@elefante-borneu-yul-02.etica.ai
#   mosh user@elefante-borneu-yul-02.etica.ai (TODO: install Mosh)
#   ssh user@ebyul02.etica.ai
#   mosh user@ebyul02.etica.ai (TODO: install Mosh)
#
# -----------------------------------------------------------------------------#
...
sudo vi /etc/hosts
## Adicione
# 127.0.0.1 database-01.domain-later.com  database-01
